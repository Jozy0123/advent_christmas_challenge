...
class Space:
    ...
    def __init__(self, blocked_loc):
        ...
        self.max_height = max(self.blocked_loc, key=lambda x: x[1])
    ...
    def move_sand(self):
        ...
        while True:
            ...
            while True:
                ...
                check_abyss = sand.check_if_abyss(self.max_height[1])
                if check_abyss is True:
                    return Sand.get_sand_num() - 1
...
class Sand:
    ...
    def check_if_abyss(self, max_height):
        if self.loc[1] >= max_height:
            return True
        else:
            return False
